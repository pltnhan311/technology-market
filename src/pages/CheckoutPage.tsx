...
export function CheckoutPage() {
    ...
    const { step, shippingInfo } = useCheckoutStore();
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white p-6 md:p-8 rounded-lg border">
                            {step === 1 && <ShippingForm />}
                            {step === 2 && <div>Step 2 - Payment (Coming next)</div>}
                            {step === 3 && <div>Step 3 - Review (Coming next)</div>}
                        </div>
                    </div>

                    {/* Right Column - Order Summary */}
                    <div className="lg:col-span-1">
                        {/* Mobile: Collapsible summary can be added here */}
